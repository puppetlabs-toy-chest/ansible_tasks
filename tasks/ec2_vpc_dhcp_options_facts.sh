...
if [ ! -z "${PT_dhcp_options_ids+x}" ];
  then params="${params} dhcp_options_ids=\"${PT_dhcp_options_ids}\""
fi
...
ansible localhost -m ec2_vpc_dhcp_options_facts --args "${params}" --one-line | cut -f2- -d">"